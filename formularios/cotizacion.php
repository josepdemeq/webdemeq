<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $content = "<html>
                    ...
                    <h1 style='color:#000000;font-weight:bold;'> " . $name . " " . $surname . " de la empresa  " . $company . " nos env&iacute;a un pedido de cotizaci&oacute;n.</h1>
                    ...
                    <div style='border: 1px solid #333;overflow: hidden;width: 100%;max-width: 600px;'>
                        ...
                        <div style='background: #ffffff;color: #000;width:100%;padding:10px;border-bottom:2px solid #000;font-weight: 600;'>
                            ...
                            <div style='width: 49%;display: inline-block;margin: 0;'>Pa&iacute;s</div>
                        </div>
                        <div style='background: #ffffff;;width:100%;padding:10px;border-bottom:1px solid #000000;'>
                            ...
                            <div style='width: 49%;display: inline-block;margin: 0;'> " . $country . " </div>
                        </div>
                        <div style='background: #ffffff;color: #000;width:100%;padding:10px;border-bottom:2px solid #000;font-weight: 600;'>
